...
function PakistanWorkVisaPage() {
    return (
        <div className="pak-work-visa-documents">
            ...
            <p>PLEASE NOTE: In case you have all of the above documents and a salary over 58.400€ or a salary over 45,552€ in a "MINT" profession, then you might be eligible for the Blue card type of visa. Please click <a href="https://pakistan.diplo.de/pk-en/service/-/2593356">HERE</a> for futher information about it.</p>
            <p>Additionally: You also have to provide all original documents (including all of your passports). They will be returned to you on the same day (except the passport you intend to travel on which stays with the Embassy during the processing time of your visa application). Please also bring a pen.</p>
            <p>For further and detailed information regarding every single document, please click <a href="https://pakistan.diplo.de/blob/2582906/b20245606d8283b822cad5129bb55710/skilled-worker-holding-a-university-degree-data.pdf">HERE</a></p>
        </div>
    );
}
