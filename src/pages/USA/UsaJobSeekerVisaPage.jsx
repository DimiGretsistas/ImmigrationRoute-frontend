...
function UsaJobSeekerVisaPage() {
    return (
        <div className="usa-jobseeker-visa-documents">
            <h1>Persons holding a US passport may apply for their residence permit at the local immigration office (Ausländerbehörde) after arrival in Germany and without having obtained a visa prior to travelling to Germany.</h1>
